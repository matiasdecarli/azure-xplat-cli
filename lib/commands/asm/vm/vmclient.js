        ...
        if (result.error) {
          ...
          computeManagementClient.virtualMachines.get(result.deployment.svc, result.deployment.deploy.name, vmName, function(error, response) {
            ...
            if (error) {
              ...
              //super experimental              
              var epToUpdateWProbe = configurationSets[m].inputEndpoints[i].loadBalancerProbe;
              if (options.probePort) {
                epToUpdateWProbe.port = options.probePort;
              }

              if (options.probePath) {
                epToUpdateWProbe.path = options.probePath;
              }
              ...
              configurationSets[m].inputEndpoints[i].loadBalancerProbe = epToUpdateWProbe;
